...
//			System.out.println(term1+" : "+term2);
    ...
    public static boolean HasSimilarWords(String term1, String term2, String type, String className) {
            ...
            if (partialWords1 != null && partialWords2 != null) {
                for (int i = 0; i < partialWords1.length; i++) {
                    for (int j = 0; j < partialWords2.length; j++) {
                        if (partialWords1[i].equalsIgnoreCase(partialWords2[j]) && !partialWords1[i].equalsIgnoreCase(className)) {
            ...
            if (similarWordForTerm1 != null && similarWordForTerm2 != null) {
                for (int i = 0; i < similarWordForTerm1.length; i++) {
                    for (int j = 0; j < similarWordForTerm2.length; j++) {
                        if (similarWordForTerm1[i].equalsIgnoreCase(similarWordForTerm2[j]) && !similarWordForTerm1[i].equalsIgnoreCase(className)) {
                            status = true;
                            break;
                        }
                    }
                ...
                for (int i = 0; i < similarWordForTerm2.length; i++) {
                    if (simpleWord1.equalsIgnoreCase(similarWordForTerm2[i]) && !simpleWord1.equalsIgnoreCase(className)) {
                        status = true;
                        break;
                    }
                }
                ...
                for (int i = 0; i < similarWordForTerm1.length; i++) {
                    if (simpleWord2.equalsIgnoreCase(similarWordForTerm1[i]) && !simpleWord2.equalsIgnoreCase(className)) {
                        status = true;
                        break;
                    }
                }
