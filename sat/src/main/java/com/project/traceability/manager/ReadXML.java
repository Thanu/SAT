...
//			}
			...
			relationNodes.addAll(RequirementSourceCodeAttributeManager.mapAttributes());
			relationNodes.addAll(RequirementSourceCodeMethodManager.mapAttributes());
			relationNodes.addAll(RequirementUMLAttributeManager.mapAttributes());
			relationNodes.addAll(RequirementUMLMethodManager.mapAttributes());
