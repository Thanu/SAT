...
public abstract class APreviewFrame
{
    ...
    protected void AddGraph()
    {
		...
		Container container;
		try {
			File file = new File(PropertyFile.generatedGexfFilePath);//"C:/Users/Thanu/Documents/atom-3.gexf");
...
//        Import(container);
    ...
    protected void Prepare()
    {
        ...
        target.zoomPlus();    target.zoomPlus();    target.zoomPlus();    target.zoomPlus();    target.zoomPlus();
